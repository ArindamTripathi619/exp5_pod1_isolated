...
if ! pgrep -x "ollama" > /dev/null; then
    ...
    nohup ollama serve > /tmp/ollama_pod1.log 2>&1 &
    sleep 5
...
# Run experiment
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Step 4: Running Experiment 5 - ISOLATED Configuration"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ "$BACKGROUND" = "true" ]; then
    ...
    echo "   watch -n 10 'sqlite3 results/exp5_isolated.db \"SELECT COUNT(*) FROM execution_traces\"'"
    echo ""
